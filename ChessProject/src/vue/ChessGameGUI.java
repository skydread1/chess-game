...
/**
 * @author lucas.loïc 
 * Cette classe permet de gérer toute la partie graphique, la partie vue 
 * et notament l'initialisation du plateau et la gestion des MouseEvent.
 *
 */
...
public class ChessGameGUI extends javax.swing.JFrame implements java.awt.event.MouseListener, java.awt.event.MouseMotionListener, java.util.Observer{
	...
	public ChessGameGUI(java.lang.String name,
		...
		ChessGameGUI.dim=boardSize;
		init();
	}

	/**
	 * @return la dimension du plateau du ChessGameControler
	 */
	...
	public void mousePressed(MouseEvent e)
	{
		...
		else
		{
			...
			//List<Coord> casesDeplacementPossible=this.chessGameControler.whereCanYouGo(0,6);
